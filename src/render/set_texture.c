...
void	init_texture(void)
{
	...
	&g_data.sprites[0].bpp, &g_data.sprites[0].ll, &g_data.sprites[0].end);
	g_data.sprites[1].adr = mlx_get_data_addr(g_data.sprites[1].ptr, \
	&g_data.sprites[1].bpp, &g_data.sprites[1].ll, &g_data.sprites[1].end);
	g_data.sprites[2].adr = mlx_get_data_addr(g_data.sprites[2].ptr, \
	&g_data.sprites[2].bpp, &g_data.sprites[2].ll, &g_data.sprites[2].end);
	g_data.sprites[3].adr = mlx_get_data_addr(g_data.sprites[3].ptr, \
	&g_data.sprites[3].bpp, &g_data.sprites[3].ll, &g_data.sprites[3].end);
}
