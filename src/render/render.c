...
/*   Updated: 2022/08/16 19:42:33 by tbrebion         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mlx(void)
{
	...
	g_data.game.win = mlx_new_window(g_data.game.mlx, 920, 680, "./cub3d");
	g_data.game.img = mlx_new_image(g_data.game.mlx, 920, 680);
