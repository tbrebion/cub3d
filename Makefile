...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/10/04 11:56:26 by flcarval          #+#    #+#              #
#    Updated: 2022/10/04 11:56:27 by flcarval         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
lib.release			:=  -Lminilibx-linux -lmlx -lX11 -lXext -Lminilibx-linux -lmlx -L./Lib42 -l42 -lm
